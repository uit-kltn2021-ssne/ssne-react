                ...
                <Space wrap style={{ marginBottom: 10 }}>
                    ...
                    >
                        ...
                        <Space direction="vertical">
                            <DatePicker onChange={getDateFrom}   placeholder="Chọn ngày bắt đầu" style={{ margin:"10px",width: "340px"}}/>
                            
                        </Space>,
                        <Space direction="vertical">
                            <DatePicker onChange={getDateTo}   placeholder="Chọn ngày  kết thúc" style={{ margin:"10px",width: "340px"}}/>
                        </Space>,
                        <TextArea
                        ...
                        />
                        <Switch checkedChildren="Đã Hoàn Thành" unCheckedChildren="Chưa Hoàn Thành" style={{ margin:"10px"}} />
                    </Modal>
